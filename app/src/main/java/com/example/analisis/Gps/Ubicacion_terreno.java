...
import com.example.analisis.terreno;

import java.util.List;

public class Ubicacion_terreno implements LocationListener {
    terreno mainActivity;

    public terreno getMainActivity() {
        return mainActivity;
    }
    public void setMainActivity(terreno mainActivity) {
